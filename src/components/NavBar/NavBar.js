...
const NavBar = () => {
  ...
  return (
    <nav className="bg-black fixed z-10 right-0 left-0 md:static p-4 md:container md:flex md:py-2 md:justify-between md:items-center border-b-2 border-blue-200 md:border-0 ">
